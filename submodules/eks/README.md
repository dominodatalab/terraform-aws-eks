...
| <a name="input_eks_public_access_cidrs"></a> [eks\_public\_access\_cidrs](#input\_eks\_public\_access\_cidrs) | EKS API endpoint public access CIDRs | `list(string)` | `null` | no |
