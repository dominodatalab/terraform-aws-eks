...
| <a name="input_irsa"></a> [irsa](#input\_irsa) | IRSA object. | <pre>object({<br>    enabled                    = bool<br>    namespace_service_accounts = list(string)<br>  })</pre> | n/a | yes |
