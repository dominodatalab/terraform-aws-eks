data "terraform_remote_state" "infra" {
  ...
  config = {
    path = var.infra_state_file != null ? var.infra_state_file : "${path.module}/../infra/terraform.tfstate"
  }
}
...
data "terraform_remote_state" "eks" {
  ...
  config = {
    path = var.cluster_state_file != null ? var.cluster_state_file : "${path.module}/../cluster/terraform.tfstate"
  }
}
