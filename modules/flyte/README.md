...
| [aws_iam_role_policy_attachment.attach_provided_key_policy_to_flyte_controlplane](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.attach_provided_key_policy_to_flyte_dataplane](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_kms_info"></a> [kms\_info](#input\_kms\_info) | key\_id         = KMS key id.<br/>    key\_arn        = KMS key arn.<br/>    enabled        = KMS key is enabled<br/>    key\_policy\_arn = KMS Policy ARN when key is provided<br/>    provided\_key   = If KMS Key was provided | <pre>object({<br/>    key_id         = string<br/>    key_arn        = string<br/>    enabled        = bool<br/>    key_policy_arn = optional(string, null)<br/>    provided_key   = optional(bool, false)<br/>  })</pre> | n/a | yes |
