...
| <a name="input_domino_cost"></a> [domino\_cost](#input\_domino\_cost) | Determines whether to provision domino cost related infrastructures, ie, long term storage | <pre>object({<br>    storage_enabled = optional(bool, true),<br>    part_size = optional(number, 134217728)<br>  })</pre> | `{}` | no |
