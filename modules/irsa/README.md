...
| <a name="input_karpenter"></a> [karpenter](#input\_karpenter) | Config to create IRSA role for Karpenter. | <pre>object({<br>    enabled             = optional(bool, false)<br>    namespace           = optional(string, "karpenter")<br>    serviceaccount_name = optional(string, "karpenter")<br>    region              = optional(string)<br>  })</pre> | `{}` | no |
...
| <a name="output_karpenter"></a> [karpenter](#output\_karpenter) | Karpenter role info |
