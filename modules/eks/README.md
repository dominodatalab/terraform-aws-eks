...
| <a name="input_karpenter"></a> [karpenter](#input\_karpenter) | Karpenter enabled toggle and namespace to install karpenter | <pre>object({<br/>    enabled   = optional(bool, false)<br/>    namespace = optional(string, "karpenter")<br/>  })</pre> | `{}` | no |
