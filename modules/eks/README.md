...
| [null_resource.debug_kms_info](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
| [null_resource.debug_storage_info](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
...
| <a name="input_kms_info"></a> [kms\_info](#input\_kms\_info) | key\_id  = KMS key id.<br/>    key\_arn = KMS key arn.<br/>    enabled = KMS key is enabled<br/>    key\_policy\_arn = KMS Policy ARN when key is provided | <pre>object({<br/>    key_id         = optional(string, null)<br/>    key_arn        = optional(string, null)<br/>    enabled        = optional(bool, true)<br/>    key_policy_arn = optional(string, null)<br/>    provided_key   = optional(bool, false)<br/>  })</pre> | `{}` | no |
