...
| <a name="input_filetask_objectstore_mount_enabled"></a> [filetask\_objectstore\_mount\_enabled](#input\_filetask\_objectstore\_mount\_enabled) | Grant the node role the S3 Files mount permissions the EFS CSI driver needs when mounting a file system for Domino's s3-native filetask dataset storage. | `bool` | `false` | no |
