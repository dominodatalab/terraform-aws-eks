...
| <a name="input_calico_image_registry"></a> [calico\_image\_registry](#input\_calico\_image\_registry) | Calico image registry | `string` | `"quay.io"` | no |
| <a name="input_calico_version"></a> [calico\_version](#input\_calico\_version) | Calico operator version. | `string` | `"v3.27.3"` | no |
