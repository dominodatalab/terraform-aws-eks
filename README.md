...
| <a name="input_vpc_endpoint_services"></a> [vpc\_endpoint\_services](#input\_vpc\_endpoint\_services) | VPCs endpoints services | <pre>list(object({<br>    name     = string<br>    ports    = list(number)<br>    cert_arn = string<br>  }))</pre> | `[]` | no |
